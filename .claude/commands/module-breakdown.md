...
```powershell
C:/Users/12108/miniconda3/python.exe scripts/collect.py `
...
C:/Users/12108/miniconda3/python.exe scripts/split_and_register.py --propose `
  --file 'docs/runs/<run_id>/artifacts/module_breakdown.md' `
  --version '<version>' `
...
C:/Users/12108/miniconda3/python.exe scripts/split_and_register.py --apply `
...
```powershell
C:/Users/12108/miniconda3/python.exe scripts/lineage.py --check
C:/Users/12108/miniconda3/python.exe scripts/lineage.py --diff        # 单独看差分候选
```
